  ...
  return (
    ...
    <nav className="sticky top-0 flex justify-between md:justify-start bg-gradient-to-r from-spurs-black to-spurs-gray text-white p-4 z-50">
      ...
      <Link
        href={'/'}
      >
        <div className="text-spurs-black cursor-pointer w-[40px] lg:w-[80px] transition-transform duration-300 hover:translate-y-1">
      ...
      <div className="hidden lg:flex gap-4 xl:gap-8 items-center">
        <Link href={'/#actualite'}>
          <div className="cursor-pointer transition-transform duration-300 hover:translate-y-1">Actualité</div>
        </Link>

        <Link href={'/classement'}>
          <div className="cursor-pointer transition-transform duration-300 hover:translate-y-1">Classement</div>
        </Link>

        <Link href={'/equipes'}>
          <div className="cursor-pointer transition-transform duration-300 hover:translate-y-1">Équipes</div>
        </Link>

        <Link href={'/joueurs'}>
          <div className="cursor-pointer transition-transform duration-300 hover:translate-y-1">Joueurs</div>
        </Link>

        <Link href={'/histoire'}>
          <div className="cursor-pointer transition-transform duration-300 hover:translate-y-1">Histoire</div>
        </Link>
      </div>
